...
public class CourbeDureeJog extends JFrame {
	...
	public static void main(String[] args) {
		...
		CourbeDureeJog demo = new CourbeDureeJog();
        ...
        for (int i = 0; i < sessions1.size(); i++) {
            series1.add(i + 1, sessions1.get(i).getJogging().getDuree());
        }
        ...
        for (int i = 0; i < sessions2.size(); i++) {
            series2.add(i + 1, sessions2.get(i).getJogging().getDuree());
        }
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "Comparaison de Durée de Jogging entre " +CompareAmis.user.getPseudo()+ " et " +CompareAmis.FriendPseudonyme, // titre du graphique
