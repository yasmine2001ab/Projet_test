...
public class CamembertNBflechesTir extends JFrame {
	...
	public static void main(String[] args) {
		...
		CamembertNBflechesTir demo = new CamembertNBflechesTir(pseudoUtilisateur);
		
		 DefaultPieDataset dataset = new DefaultPieDataset();
	        JFreeChart chart = ChartFactory.createPieChart("Nombre de fleches Tir a l'arc en Camembert de  "     +pseudoUtilisateur, dataset, true, true, false);
       ...
       // User user = (User) session.get(User.class, 1);
		...
		for (int i = 0; i < sessions.size(); i++) {
			dataset.setValue("Nombre de Fleches"+(i+1), sessions.get(i).getTir_a_larc().getNbFleches());
		}
	...
	public CamembertNBflechesTir(String pseudoUtilisateur) {
