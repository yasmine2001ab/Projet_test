...
public class CourbePoidBatKayak extends JFrame {
	...
	public static void main(String[] args) {
		...
		CourbePoidBatKayak demo = new CourbePoidBatKayak();
		...
		XYSeries series1 = new XYSeries("PoidBat");
		for (int i = 0; i < sessions.size(); i++) {
			series1.add(i+1, sessions.get(i).getKayak().getPoidBat());
		}
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "PoidBat Kayak Courbe de  "   +pseudoUtilisateur, // titre du graphique
