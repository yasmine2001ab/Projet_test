	...
	public static void main(String[] args) {
     ...
     // Créer la série de données pour user1
        ...
        for (int i = 0; i < sessions1.size(); i++) {
            series1.add(i + 1, sessions1.get(i).getKayak().getVitesse());
        }
        ...
        for (int i = 0; i < sessions2.size(); i++) {
            series2.add(i + 1, sessions2.get(i).getKayak().getVitesse());
        }
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "Comparaison de Vitesse de Kayak entre " +CompareAmis.user.getPseudo()+ " et " +CompareAmis.FriendPseudonyme, // titre du graphique
