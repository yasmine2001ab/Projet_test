...
public class Musculation extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Musculation window = new Musculation(pseudoUtilisateur);
	...
	public Musculation(String pseudoUtilisateur) {
	...
	private void initialize() {
		...
		btnCompamis.setBounds(10, 418, 143, 36);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CourbeDureeMusculation.main(new String[] {pseudoUtilisateur});
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CamembertPoidsSouleveMusculation.main(new String[] {pseudoUtilisateur});
		...
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				HistoRepetitionMusculation.main(new String[] {pseudoUtilisateur});
