...
public class Equitation extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Equitation window = new Equitation(pseudoUtilisateur);
	...
	public Equitation(String pseudoUtilisateur) {
       ...
       // initialize();
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pseudoUtilisateur = lblNewLabel.getText();
		        CamembertGraph.main(new String[] {pseudoUtilisateur});
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pseudoUtilisateur = lblNewLabel.getText();
				CourbeGraph.main(new String[] {pseudoUtilisateur});
		...
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pseudoUtilisateur = lblNewLabel.getText();
				EquitationGraph.main(new String[] {pseudoUtilisateur});
