...
import GrapheTir_a_larc.CamembertNBflechesTir;
import GrapheTir_a_larc.CourbeDistanceTir_a_larc;
import GrapheTir_a_larc.CourbeDureeTir;
import GrapheTir_a_larc.HistoScoreTir_a_larc;
...
public class Tir_a_arc extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Tir_a_arc window = new Tir_a_arc(pseudoUtilisateur);
	...
	public Tir_a_arc(String pseudoUtilisateur) {
	...
	private void initialize() {
		...
		ImageIcon icon1 = new ImageIcon(getClass().getResource("C/images/sports.png"));
		...
		btnCompamis.setBounds(11, 415, 142, 36);
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CourbeDistanceTir_a_larc.main(new String[] {pseudoUtilisateur});
		...
		btnPoidbat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CamembertNBflechesTir.main(new String[] {pseudoUtilisateur});
		...
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				HistoScoreTir_a_larc.main(new String[] {pseudoUtilisateur});
