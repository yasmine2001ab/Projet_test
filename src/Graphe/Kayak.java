...
import GrapheKayak.CamembertDistanceKayak;
import GrapheKayak.CourbePoidBatKayak;
import GrapheKayak.CourbeVitesseKayak;
import GrapheKayak.histoDureeKayak;
...
public class Kayak extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Kayak window = new Kayak(pseudoUtilisateur);
	...
	public Kayak(String pseudoUtilisateur) {
	...
	private void initialize() {
		...
		btnCompamis.setBounds(10, 419, 143, 36);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				histoDureeKayak.main(new String[] {pseudoUtilisateur});
				frame.setVisible(false);
				dispose();
			}
		});
		...
		btnPoidbat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CourbePoidBatKayak.main(new String[] {pseudoUtilisateur});
