...
public class Jogging extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Jogging window = new Jogging(pseudoUtilisateur);
	...
	public Jogging(String pseudoUtilisateur) {
	...
	private void initialize() {
		...
		btnCompamis.setBounds(10, 416, 143, 36);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CourbeDureeJogging.main(new String[] {pseudoUtilisateur});
		...
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CourbeVitesseJogging.main(new String[] {pseudoUtilisateur});
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				HistoDistanceJogging.main(new String[] {pseudoUtilisateur});
		...
		btnFrequence.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = lblNewLabel.getText();
				CamembertFrequenceJogging.main(new String[] {pseudoUtilisateur});
