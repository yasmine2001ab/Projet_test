...
public class ModifierSports extends JFrame {
	...
	public static void main(String[] args) {
		...
		ModifierSports frame = new ModifierSports(pseudoUtilisateur);
	...
	public ModifierSports(String pseudoUtilisateur) {
...
//					nbSports--;
		...
		lblNewLabel_6.setBounds(10, 10, 131, 13);
		...
		btnNewButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				Query query = session.createQuery("DELETE FROM Choix WHERE user = :user").setParameter("user", user.getIdUser());
				query.setParameter("user", user);
				query.executeUpdate();
				
				//Select.deleteChoix(user);
