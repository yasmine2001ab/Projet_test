...
public class AmisW extends JFrame {
	...
	public static void main(String[] args) {
	    ...
	    AmisW frame = new AmisW(pseudoUtilisateur);
	...
	public AmisW(String pseudoUtilisateur) {
		...
		if (!idFriends.isEmpty()){
			for (Integer id : idFriends) {
				...
				btnNewButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						Ami a = new Ami(user, btnNewButton.getText());
						a.setVisible(true);
						dispose();
					}
				});
