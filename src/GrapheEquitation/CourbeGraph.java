...
public class CourbeGraph extends JFrame {
	...
	public static void main(String[] args) {
		...
		CourbeGraph demo = new CourbeGraph();
		...
		for (int i = 0; i < sessions.size(); i++) {
			...
			series1.add(i+1, sessions.get(i).getEquitation().getDistance());
		}
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "Distance Equitation de  "   +pseudoUtilisateur, // titre du graphique
