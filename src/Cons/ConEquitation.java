...
public class ConEquitation extends JFrame {
	...
	public static void main(String[] args) {
	    ...
	    ConEquitation frame = new ConEquitation(pseudoUtilisateur);
	...
	public ConEquitation(String pseudoUtilisateur) {
	...
	private void initialize() {
		...
		btnMjrActivits1.setBounds(-14, 364, 148, 36);
		...
		btnCompamis.setBounds(10, 410, 143, 36);
		...
		lblNewLabel.setBounds(62, 89, 154, 21);
		...
		lblEtatDesprit.setBounds(60, 228, 120, 21);
		...
		User user = (User) session.get(User.class, Select.findUser1(pseudoUtilisateur).getIdUser());
		 Query query = session.createQuery("FROM ActiviteEquitation WHERE user = :user ORDER BY id DESC").setMaxResults(3);
		...
		ImageIcon iconEquit = new ImageIcon(new ImageIcon(getClass().getResource("/images/equitation.jpg")).getImage().getScaledInstance(170, 170, 30));
		...
		lblNewLabel_2.setBounds(70, 276, 210, 13);
		...
		btnAjouter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Equitation eq = new Equitation(Integer.parseInt(textField_duree.getText()), Double.parseDouble(textField_distance.getText()), 
						Double.parseDouble(textField_vitesse.getText()), sport);
				//Very useful, the save method can return an auto-generated Id.
				session.save(eq);
				ActiviteEquitation actEq = new ActiviteEquitation(user, eq);
