...
import GrapheKayakCompareAmis.CamembertDistanceKayak;
import GrapheKayakCompareAmis.CourbePoidsBatKayak;
import GrapheKayakCompareAmis.CourbeVitesseKayak;
import GrapheKayakCompareAmis.HisyoDureeKayak;
...
public class Kayak extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Kayak window = new Kayak(user, FriendPseudonyme);
	...
	public Kayak(User user, String FriendPseudonyme) {
		Kayak.user = user;
		Kayak.FriendPseudonyme = FriendPseudonyme;
		...
		btnMjrActivits1.setBounds(-13, 373, 148, 36);
		...
		btnCompamis.setBounds(10, 418, 135, 36);
		...
		lblNewLabel.setBounds(44, 69, 227, 21);
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CamembertDistanceKayak.main(new String[] {pseudoUtilisateur});
				
			}
		});
		btnDistance.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnDistance.setBounds(359, 173, 145, 85);
		boutonChoisi.add(btnDistance);
		
		JButton btnPoidbat = new JButton("PoidBat");
		btnPoidbat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CourbePoidsBatKayak.main(new String[] {pseudoUtilisateur});
				
			}
		});
		btnPoidbat.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnPoidbat.setBounds(359, 305, 145, 85);
		boutonChoisi.add(btnPoidbat);
		
		JButton btnVvitesse = new JButton("Vitesse");
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CourbeVitesseKayak.main(new String[] {pseudoUtilisateur});
				
			}
		});
		btnVvitesse.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnVvitesse.setBounds(92, 305, 145, 85);
		...
		btnNewButton_1.setBounds(474, 488, 117, 31);
