...
import GrapheJogging.CourbeVitesseJogging;
import GrapheJogging.HistoDistanceJogging;
import GrapheJoggingCompareAmis.CamembertFrequenceJog;
import GrapheJoggingCompareAmis.CourbeDureeJog;
import GrapheJoggingCompareAmis.CourbeVitesseJog;
import GrapheJoggingCompareAmis.HistoDistanceJog;
...
public class Jogging extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Jogging window = new Jogging(user, FriendPseudonyme);
	...
	public Jogging(User user, String FriendPseudonyme) {
		Jogging.user = user;
		Jogging.FriendPseudonyme = FriendPseudonyme;
		...
		btnCompamis.setBounds(10, 416, 137, 36);
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				HistoDistanceJog.main(new String[] {pseudoUtilisateur});
				
				
			}
		});
		btnDistance.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnDistance.setBounds(352, 149, 145, 85);
		boutonChoisi.add(btnDistance);
		
		JButton btnFrequence = new JButton("Frequence");
		btnFrequence.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CamembertFrequenceJog.main(new String[] {pseudoUtilisateur});
				
			}
		});
		btnFrequence.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnFrequence.setBounds(352, 281, 145, 85);
		boutonChoisi.add(btnFrequence);
		...
		btnNewButton_1.setBounds(480, 492, 117, 31);
