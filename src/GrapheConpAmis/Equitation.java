...
import GrapheEquitaCompAmis.CourbeEqui;
...
public class Equitation extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Equitation window = new Equitation(user, FriendPseudonyme);
	...
	public Equitation(User user, String FriendPseudonyme) {
		//this.pseudoUtilisateur = pseudoUtilisateur;
       // initialize();
		Equitation.user = user;
		Equitation.FriendPseudonyme = FriendPseudonyme;
		frame = new JFrame();
		// this.pseudoUtilisateur=pseudoUtilisateur;
		...
		btnCompamis.setBounds(10, 424, 137, 36);
		...
		lblNewLabel.setBounds(44, 69, 224, 21);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pseudoUtilisateur = pseudoUser.getText();
		        GrapheUtiAmis.main(new String[] {pseudoUtilisateur});
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pseudoUtilisateur = pseudoUser.getText();
				CourbeEqui.main(new String[] {pseudoUtilisateur});
		...
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String pseudoUtilisateur = pseudoUser.getText();
				CamembertEqui.main(new String[] {pseudoUtilisateur});
		...
		btnNewButton_1.setBounds(476, 486, 117, 31);
