...
import GrapheMusculationCompareAmis.CamembertPoidsSouleveMusc;
import GrapheMusculationCompareAmis.CourbeDureeMusc;
import GrapheMusculationCompareAmis.HistoRepetitionMusc;
...
public class Musculation extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Musculation window = new Musculation(user, FriendPseudonyme);
	...
	public Musculation(User user, String FriendPseudonyme) {
		Musculation.user = user;
		Musculation.FriendPseudonyme = FriendPseudonyme;
		...
		btnMjrActivits1.setBounds(-12, 372, 148, 36);
		...
		btnCompamis.setBounds(10, 421, 137, 36);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CourbeDureeMusc.main(new String[] {pseudoUtilisateur});
		...
		JButton btnDistance = new JButton("PoidsSouleve");
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CamembertPoidsSouleveMusc.main(new String[] {pseudoUtilisateur});
		...
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				HistoRepetitionMusc.main(new String[] {pseudoUtilisateur});
		...
		btnNewButton_1.setBounds(470, 489, 117, 31);
