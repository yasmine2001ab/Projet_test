...
import GrapheTirCompareAmis.CourbeDistanceTir;
import GrapheTirCompareAmis.HistoScoreTir;
import GrapheTirCompareAmis.CamembertNBFlecheTir;
import GrapheTirCompareAmis.CourbeDureeTir;
...
public class Tir extends JFrame{
	...
	public static void main(String[] args) {
	    ...
	    Tir window = new Tir(user, FriendPseudonyme);
	...
	public Tir(User user, String FriendPseudonyme) {
		Tir.user = user;
		Tir.FriendPseudonyme = FriendPseudonyme;
		...
		btnMjrActivits1.setBounds(-12, 369, 148, 36);
		...
		btnCompamis.setBounds(10, 415, 137, 36);
		...
		lblNewLabel.setBounds(44, 69, 228, 21);
		...
		btnDistance.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CourbeDistanceTir.main(new String[] {pseudoUtilisateur});
				 
			}
		});
		btnDistance.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnDistance.setBounds(359, 173, 180, 98);
		boutonChoisi.add(btnDistance);
		
		JButton btnPoidbat = new JButton("Nombre de Fleches");
		btnPoidbat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				CamembertNBFlecheTir.main(new String[] {pseudoUtilisateur});
				
			}
		});
		btnPoidbat.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnPoidbat.setBounds(359, 305, 180, 98);
		boutonChoisi.add(btnPoidbat);
		
		JButton btnVvitesse = new JButton("Score");
		btnVvitesse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String pseudoUtilisateur = pseudoUser.getText();
				HistoScoreTir.main(new String[] {pseudoUtilisateur});
				
			}
		});
		btnVvitesse.setFont(new Font("Segoe UI Emoji", Font.BOLD, 15));
		btnVvitesse.setBounds(92, 305, 180, 98);
		...
		btnNewButton_1.setBounds(469, 492, 117, 31);
