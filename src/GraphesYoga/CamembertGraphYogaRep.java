...
public class CamembertGraphYogaRep extends JFrame {
	...
	public static void main(String[] args) {
		...
		CamembertGraphYogaRep demo = new CamembertGraphYogaRep(pseudoUtilisateur);
		
		DefaultPieDataset dataset = new DefaultPieDataset();
        JFreeChart chart = ChartFactory.createPieChart("Répétition Yoga en Camembert de  " +pseudoUtilisateur, dataset, true, true, false);
		...
		for (int i = 0; i < sessions.size(); i++) {
			dataset.setValue("Repetition"+(i+1), sessions.get(i).getYoga().getRepetition());
		}
	...
	public CamembertGraphYogaRep(String pseudoUtilisateur) {
