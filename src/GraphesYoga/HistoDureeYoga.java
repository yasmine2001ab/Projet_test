...
public class HistoDureeYoga extends JFrame{
	private String pseudoUtilisateur;
	public HistoDureeYoga(String pseudoUtilisateur) {
    ...
    public static void main(String[] args) {
		...
		HistoDureeYoga demo = new HistoDureeYoga(pseudoUtilisateur);
        ...
        for (int i = 0; i < sessions.size(); i++) {
            dataset.addValue(sessions.get(i).getYoga().getDuree(), "Durée", "Résultat " + (i+1));
        }
        
        // Créer le graphique en histogrammes
        JFreeChart chart = ChartFactory.createBarChart(
                "Durée Yoga Histogram de  "  +pseudoUtilisateur,
                "Session",
                "Min",
                dataset,
