...
public class CourbeVitesseJogging extends JFrame {
	...
	public static void main(String[] args) {
		...
		CourbeVitesseJogging demo = new CourbeVitesseJogging();
		...
		for (int i = 0; i < sessions.size(); i++) {
			series1.add(i+1, sessions.get(i).getJogging().getVitesse());
		}
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(
                "Vitesse Jogging de  "   +pseudoUtilisateur, // titre du graphique
